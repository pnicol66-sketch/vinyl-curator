...
|---|---|---|
| 2.12 | 2026-09-05 | **Sales are filed by tiers, label eras split the originals, Music Direct joins the dealers.** Sellers shorthand catalogue prefixes ("LP 7012", "7012", "BN 4006"), so a documented sale is now filed in a fixed order: reissue markers first, then your copy's exact prefix and number, then the number alone; mono versus stereo, the other speed, and an earlier or later label era (Prestige 446 W 50th versus Bergenfield, Blue Note Lexington versus 47 W 63rd versus New York USA, Columbia six-eye versus two-eye) are variants of the original-era market, never your edition. Every sale carries the reason it was filed where it was. The label era of your copy comes only from what you have typed about its label. The price check light now measures against the market the named comparable sits in. Music Direct is read as the third dealer. |
...
**Every documented sale is filed by tiers, with its reason.** Sellers shorthand catalogue prefixes, and a reissue listing usually quotes the original's number, so the evidence files each sale in a fixed order. For an original pressing: any reissue marker first (MoFi, OJC, Analogue Productions, 180g, Japan, a year five or more years after yours), then your copy's exact prefix and number ("PRLP 7012"), then the number alone as its own token ("LP 7012", "Prestige 7012", "7012", "BN 4006"). A stereo sale of a mono copy, a 45 rpm cut, and a sale whose title states an earlier or later label era than your copy's are filed as variants of the original-era market, so they can still inform the valuation but are never called your edition. The label era comes from a cited living table (Prestige, Blue Note, Riverside, Atlantic, Impulse and Verve by address or company wording; Columbia by its six-eye, two-eye and red label designs) and is compared only when your own Label Notes, LP Notes, pressing brief or Label Comments record what your label shows, so the sheet never infers an era from a number and a date. A sale of the same label era is marked and listed first. Every sale in the evidence carries the reason it was filed where it was ("number 7012; same label (446 W 50th St NYC)", "earlier label", "stereo pressing (this copy is mono)", "DG, RVG"), and the price check light measures a value against the market the named comparable actually sits in. Music Direct is now read beside Acoustic Sounds and Elusive Disc, which matters most for Mobile Fidelity titles, though an out-of-stock item there is reported as out of stock, never as out of print.
...
*Vinyl Curator — User Manual v2.12 · © 2026 pnicol66*
